...
$(document).ready(() => {
    document.addEventListener('contextmenu', (e) => {
        ...
        function ContextmenuAppsContainerNSearch(id, menuselector) {
            if (id == 'DESKTOP') {
                if (localStorage.getItem('OKNA8_user_' + currentUser + '_startScreen-layout').indexOf("\"Desktop\"") == -1) {
                ...
                if (localStorage.getItem('OKNA8_user_' + currentUser + '_startScreen-layout').indexOf(id) == -1) {
                    ...
                    $(menuselector).html('<div class="element" onclick="addTile(\'MetroApp\', \'' + id + '\');displayStartTiles()">' + LOCALE_startscreen[13] + '</div>')
                } else {
                    $(menuselector).html('<div class="element" onclick="removeTile(\'MetroApp\', \'' + id + '\');displayStartTiles()">' + LOCALE_startscreen[14] + '</div>')
                }
            } else {
                console.log(id)
                if (localStorage.getItem('OKNA8_user_' + currentUser + '_startScreen-layout').indexOf(id.replace('desktop_', '')) == -1) {
                    $(menuselector).html('<div class="element" onclick="addTile(\'DesktopApp\', \'' + id.replace('desktop_', '') + '\');displayStartTiles()">' + LOCALE_startscreen[13] + '</div>')
                } else {
                    $(menuselector).html('<div class="element" onclick="removeTile(\'DesktopApp\', \'' + id.replace('desktop_') + '\');displayStartTiles()">' + LOCALE_startscreen[14] + '</div>')
                }
            }
            var contextmenutop
        ...
        if (id.startsWith('searchResult')) {
            ...
            if (id != 'DESKTOP' && !id.startsWith('desktop_')) {
                ...
                $('.metrocontextmenucompact').append('<div class="element" onclick="removeTile(\'MetroApp\', \'' + id + '\')">' + LOCALE_startscreen[14] + '</div>')
                if (typeof tilesInfo[id][7] != 'undefined' && tilesInfo[id][7].length > 0) {
                ...
                $('.metrocontextmenucompact').append('<div class="element" onclick="removeTile(\'DesktopApp\',\'' + id + '\')">' + LOCALE_startscreen[14] + '</div>')
            } else {
                $('.metrocontextmenucompact').append('<div class="element">' + LOCALE_startscreen[16] + '<div class="childmenu menusize"></div></div>')
